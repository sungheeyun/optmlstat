...
class LagrangianIllustrator:
    ...
    def create_interactive_plot(
        ...
        obj_fcn_array_1d: ndarray = self.obj_fcn.get_y_values_2d_from_x_values_1d(
            x_array_1d
        ).ravel()
        cnst_fcn_array_1d: ndarray = self.const_fcn.get_y_values_2d_from_x_values_1d(
            x_array_1d
        ).ravel()
        ...
        def update_lagrangian_in_x(value: float):
            ...
            obj_minimum_point_line_2d.set_ydata(
                ones(1)
                * obj_fcn.get_y_values_2d_from_x_values_1d(ones(1) * lagrangian_minimum_x).ravel()
            )
            if (
                self.const_fcn.get_y_values_2d_from_x_values_1d(ones(1) * lagrangian_minimum_x)[
                    0, 0
                ]
                <= 0.0
            ):
...
if __name__ == "__main__":
    ...
    lagrangian_illustrator.create_interactive_plot(
        x_min, x_max, lambda_min, lambda_max, initial_lambda
    )
